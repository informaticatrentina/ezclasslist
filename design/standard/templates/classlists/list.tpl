 ...
 * $HeadURL: http://svn.projects.ez.no/ezclasslists/trunk/ezclasslists/design/standard/templates/classlists/list.tpl $
 *}
{def
...
<tr>
    ...
    <th class="remote">{'Object Remote ID'|i18n( 'design/admin/node/view/full' )}</th>
    ...
    <th class="creator">{'Creator'|i18n( 'design/admin/node/view/full' )}</th>
    <th class="edit">&nbsp;</th>
</tr>
...
<td>
    ...
    <br /><small>{$node.path_with_names}</small>
</td>
<td class="class">
    <a href={concat( 'classlists/list/', $node.class_identifier )|ezurl()}>{$node.class_name|wash()}</a>
</td>
<td>
    <a href={concat('remoteid/update/',$node.node_id)|ezurl()}>{$node.object.remote_id|wash()}</a>
</td>
<td class="modified">
...
{literal}
$(document).ready(function() { $("table.list").tablesorter(); } );
{/literal}
</script>